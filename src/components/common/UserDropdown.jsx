      ...
      >
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200">
          <li>
            ...
            >
              <svg
                className="fill-gray-700 group-hover:fill-gray-900"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
          ...
          className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-sm hover:bg-gray-100 hover:text-gray-700 w-full text-left"
        >
          <svg
