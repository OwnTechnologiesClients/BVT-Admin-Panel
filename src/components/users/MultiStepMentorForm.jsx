      ...
      <div>
        ...
        {formData.teachingMethods.map((method, index) => (
          <div key={method.id} className="border border-gray-200 rounded-lg p-4 mb-3">
            <div className="flex items-center justify-between mb-3">
              <span className="font-medium text-gray-800">Method {index + 1}</span>
              <Button
                type="button"
                variant="outline"
                size="sm"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  value={method.method}
                  onChange={(e) => {
                    const updatedMethods = [...formData.teachingMethods];
                    updatedMethods[index].method = e.target.value;
                    setFormData(prev => ({ ...prev, teachingMethods: updatedMethods }));
                  }}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  placeholder="e.g., Hands-on training, Simulation"
                  required
                />
              </div>
